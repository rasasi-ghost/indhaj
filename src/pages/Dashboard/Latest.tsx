...
import CartImg from '../../assets/template/card2.png';
        ...
        <Card className="card-animate">
            <CardBody>
                ...
                <div className="d-flex overflow-auto ">
                    <ProjectCard />
                    {/* This container will fill available space and scroll on small screens */}
                    <div className="d-flex flex-grow-1  py-3">
                        <ChartCard />
                        <VerticalDivider />
                        <ActionCard title="Action One" buttonText="Click Me" />
                        <VerticalDivider />
                        <ActionCard title="Action Two" buttonText="Press Me" />
                    </div>
                </div>
                <div className="d-flex overflow-auto" >
                    <ProjectCard />
